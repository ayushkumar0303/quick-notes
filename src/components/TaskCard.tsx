  ...
  return (
    <div className="w-full flex items-start p-4 rounded-sm shadow-md gap-3 border-1">
      <input
        type="checkbox"
        id="checks"
        className="m-1.5 cursor-pointer accent-blue-500"
      />
      <label htmlFor="checks" className="flex flex-col justify-start">
        <p className="font-medium text-md text-blue-500">Peer React</p>
        <p className="font-extralight text-gray-600 text-sm">
